...
public class AiPlayer implements Player {
	 ...
	 */
	private ScoredMove negamax(Board board, int depth, float alpha, float beta, int color, Move moveToThisSituation){
		...
		if(depth == 0) 
			return new ScoredMove(moveToThisSituation, color * Evaluator.evaluate(board, side));
